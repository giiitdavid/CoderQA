package com.david.coderqa.generate;
...
//        String upperDataKey = "UserComment";
        ...
        System.out.println("生成 Controller 成功，文件路徑：" + outputPath);
        ...
        doGenerate(inputPath, outputPath, dataModel);
        System.out.println("生成 Service 接口成功，文件路徑：" + outputPath);
        // 生成 Service 实现类
        ...
        doGenerate(inputPath, outputPath, dataModel);
        System.out.println("生成 Service 實現類成功，文件路徑：" + outputPath);
        ...
        doGenerate(inputPath, outputPath, dataModel);
        System.out.println("生成 DTO 成功，文件路徑：" + outputPath);
        // 生成 VO
        ...
        doGenerate(inputPath, outputPath, dataModel);
        System.out.println("生成 VO 成功，文件路徑：" + outputPath);
    }
